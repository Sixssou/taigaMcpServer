/**
 * Constants and configuration for Taiga Core Library
 */
...
export const ERROR_MESSAGES = {
  ...
  FAILED_TO_UPDATE_SPRINT: 'Failed to update sprint in Taiga',
  FAILED_TO_DELETE_SPRINT: 'Failed to delete sprint from Taiga',
...
export const ADVANCED_QUERY = {
  ...
  SUPPORTED_TYPES: ['issues', 'user_stories', 'tasks'] as const,
...
export const API_ENDPOINTS = {
  ...
  EPICS: '/epics',
  EPIC_RELATED_USERSTORIES: (epicId: number) => `/epics/${epicId}/related_userstories`,
  WIKI: '/wiki',
